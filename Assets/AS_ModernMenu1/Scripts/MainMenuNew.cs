...
public class MainMenuNew : MonoBehaviour {
    ...
    private bool settingsPanelState = false;
    ...
    public void OpenSettings()
    {
        ...
        PanelGame.SetActive(settingsPanelState);
    }

    public void SetDifficulty(GameObject clickedObject)
    {
        if (clickedObject.GetComponent<Text>().text == "normal")
            PlayerPrefs.SetInt("Difficulty", 0);
        else if(clickedObject.GetComponent<Text>().text == "hardcore")
            PlayerPrefs.SetInt("Difficulty", 1);
    }

    public void SetMasterVolume(GameObject slider) 
    {
        PlayerPrefs.SetFloat("Difficulty", slider.GetComponent<Slider>().value);
    }
